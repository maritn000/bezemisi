...
export function CtaSection({
  ...
  return (
    <section className="bg-purple-950 text-white">
      <div className="site-container grid gap-8 py-14 md:grid-cols-[1fr_auto] md:items-center lg:py-20">
        <div>
        ...
        <Link href={href} className="button button-green">
          {label}
        </Link>
      </div>
    </section>
